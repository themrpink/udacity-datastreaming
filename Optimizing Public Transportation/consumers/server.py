...
def run_server():
    ...
    if topic_check.topic_exists("TURNSTILE_SUMMARY") is False:
        ...
        exit(1)
    if topic_check.topic_exists("com.udacity.optimizing_transportation.turnstile") is False:
        logger.fatal(
    ...
    consumers = [
        KafkaConsumer(
            "com.udacity.optimizing_transportation.weather",
        ...
        KafkaConsumer(
            "^com.udacity.optimizing_transportation.",
            lines.process_message,
            offset_earliest=True,
        ),
        KafkaConsumer(
